...
import type { BannerFilterState, BannerTypeFilter, BannerStatusFilter } from "./types";
import { DateRangePicker } from "../overview/DateRangePicker";

interface BannersFilterBarProps {
  filters: BannerFilterState;
  onFilterChange: (filters: Partial<BannerFilterState>) => void;
  onResetFilters: () => void;
}
...
export function BannersFilterBar({
  ...
  const statusOptions: { label: string; value: BannerStatusFilter }[] = [
    { label: "All Statuses", value: "all" },
    { label: "Active Only", value: "active" },
    { label: "Inactive Only", value: "inactive" },
  ];

  const currentTypeOption = typeOptions.find((s) => s.value === filters.type);
    ...
    <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="relative flex-1 max-w-md">
        <input
          ...
          placeholder="Search banner title or link URL..."
      ...
      <div className="flex flex-wrap items-center gap-2.5">
        ...
        <div className="relative" ref={typeRef}>
          ...
          >
            <span>{filters.type === "all" ? "Banner Type" : currentTypeOption?.label}</span>
