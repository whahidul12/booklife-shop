...
import { deleteBannerAction } from "@/features/banners/actions/banners.actions";
  ...
  async function handleDelete() {
    ...
    try {
      ...
      if (res.error) {
        ...
        onDeleted(banner.title || "Banner");
        onClose();
      }
    } catch {
      onError("Failed to delete banner");
      setIsDeleting(false);
    }
  }
    ...
    >
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl bg-white p-6 shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center gap-3.5 mb-4">
          ...
          <div>
            <h3 className="text-base font-bold text-gray-900">Delete Banner</h3>
        ...
        <p className="text-xs text-gray-600 leading-relaxed mb-6">
          ...
          It will immediately disappear from carousels and promotional areas.
        </p>
