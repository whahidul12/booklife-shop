...
import type { SubjectFilterState, SubjectStatusFilter } from "./types";
...
export function SubjectsFilterBar({
  ...
  const statusOptions: { label: string; value: SubjectStatusFilter }[] = [
    ...
    <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="relative flex-1 max-w-md">
        <input
          ...
          placeholder="Search by subject title or slug..."
      ...
      <div className="flex flex-wrap items-center gap-2.5">
        ...
        <div className="relative" ref={statusRef}>
          ...
          >
            <span>{filters.status === "all" ? "Subject Status" : currentStatusOption?.label}</span>
