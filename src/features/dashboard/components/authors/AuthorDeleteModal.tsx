...
import { deleteAuthorAction } from "@/features/books/actions/taxonomy.actions";
  ...
  async function handleDelete() {
    ...
    try {
      ...
      if (res.error) {
        ...
        onDeleted(author.name);
        onClose();
      }
    } catch {
      onError("Failed to delete author");
      setIsDeleting(false);
    }
  }
    ...
    >
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl bg-white p-6 shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center gap-3.5 mb-4">
          ...
          <div>
            <h3 className="text-base font-bold text-gray-900">Delete Author</h3>
        ...
        <p className="text-xs text-gray-600 leading-relaxed mb-6">
          ...
          <strong className="text-gray-900 font-semibold">"{author.name}"</strong>?
          Books referencing this author will have their author reference set to null.
        </p>
