...
import { deleteReviewAction } from "@/features/reviews/actions/reviews.actions";
    ...
    >
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl bg-white p-6 shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <p className="text-xs text-gray-600 leading-relaxed mb-6">
          Are you sure you want to delete this {review.rating}-star review
          {bookName ? ` for "${bookName}"` : ""}? The review rating and comment
