...
import { deleteCouponAction } from "@/features/orders/actions/coupons.actions";
    ...
    >
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl bg-white p-6 shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <p className="text-xs text-gray-600 leading-relaxed mb-6">
          ...
          <strong className="font-mono text-gray-900 font-bold">{coupon.code}</strong>?
          Shoppers will no longer be able to use this promotional discount.
        </p>
