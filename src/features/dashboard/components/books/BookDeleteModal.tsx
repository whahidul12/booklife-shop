...
import { deleteBookAction } from "@/features/books/actions/books.actions";
import type { Book } from "@/db/schema";

interface BookDeleteModalProps {
  book: Book;
  onClose: () => void;
  onDeleted: (bookName: string) => void;
    ...
    >
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl bg-white p-6 shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <p className="text-xs text-gray-600 leading-relaxed mb-6">
          ...
          <strong className="text-gray-900 font-semibold">"{book.name}"</strong> from your store?
          All associated inventory and product records will be removed.
        </p>
