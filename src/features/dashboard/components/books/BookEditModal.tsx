...
import { X, RefreshCw, Pencil, BookOpen, Sparkles } from "lucide-react";
import { updateBookAction } from "@/features/books/actions/books.actions";
...
export function BookEditModal({
  ...
  }, [submitted, isPending, state.error, onSaved, onError, onClose, book.name]);
  ...
  const currentDiscount = book.discountPricePaisa
    ? (book.discountPricePaisa / 100).toFixed(2)
    : "";
        ...
        <div className="flex items-center justify-between border-b border-gray-100 px-6 py-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Update book details and inventory info</p>
            </div>
          </div>
          <button
            type="button"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Brief synopsis or description of the book..."
                  className="w-full rounded-xl border border-gray-200 bg-white px-3.5 py-2.5 text-sm outline-none transition-all focus:border-[#D10A13] focus:ring-2 focus:ring-[#D10A13]/20"
                />
              </div>
            </div>
